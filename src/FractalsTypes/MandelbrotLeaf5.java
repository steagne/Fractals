...
public class MandelbrotLeaf5 extends Mandelbrot
{
	public MandelbrotLeaf5(int pictureWidth, int pictureHeight)
	{
	...
	public int doIterations(Complex c)
	{
		...
		z = new Complex(0, 0);
		c = Complex.divide(c.pow(2), c.pow(4).subtract(new Complex(0.25, 0)));
